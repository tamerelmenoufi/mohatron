...
<div class="row">
                <div class="form-group col-md-8">
                    ...
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao type="text" class="form-control" id="nome" name="nome" placeholder="Nome completo" value="<?=$d->nome?>">
                ...
                <div class="form-group col-md-4">
                    ...
                    <div style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" class="form-control"><?=$d->cpf?></div>
                    <div id="nome" class="form-text"></div>
                </div>
</div>
...
<div class="row">
                <div class="form-group col-md-4">
                    ...
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao type="text" tipo="data" name="birthdate" id="birthdate" class="form-control" placeholder="Data de Nascimento" value="<?=dataBr($d->birthdate)?>">
                    <div id="nome" class="form-text"></div>
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao name="maritalStatus" id="maritalStatus" class="form-select">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao name="gender" id="gender" class="form-select">
                        <option value="">:: Selecione ::</option>
...
<div class="row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao type="text" name="nationality" id="nationality" class="form-control" placeholder="Nacionalidade" value="<?=$d->nationality?>">
                    <div id="nome" class="form-text"></div>
                </div>
                <div class="form-group col-md-5">
                    <label class="form-label" for="pep">Exposta Politicamente*</label>
                    <select style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao name="pep" id="pep" class="form-select">
                        <option value="">:: Selecione ::</option>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao type="text" name="naturalness" id="naturalness" class="form-control" placeholder="Naturalidade" value="<?=$d->naturalness?>">
                    <div id="nome" class="form-text"></div>
                </div>
...
<div class="row">
                ...
                <div class="form-group col-md-8">
                    ...
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao type="email" name="email" id="email" class="form-control" placeholder="E-mail" value="<?=$d->email?>">
                    <div id="nome" class="form-text"></div>
                </div>

                <div class="form-group col-md-4">
                    <label class="form-label" for="phoneNumber">Telefone*</label>
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" 
                    acao type="text" inputmode="numeric" id="phoneNumber" class="form-control" placeholder="Telefone" value="<?=$d->phoneNumber?>">
                    <div id="nome" class="form-text"></div>
                </div>
 ...
 <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao type="text" name="motherName" id="motherName" class="form-control" placeholder="Nome da Mãe" value="<?=$d->motherName?>">
                    <div id="nome" class="form-text"></div>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao type="text" name="fatherName" id="fatherName" class="form-control" placeholder="Nome do Pai" value="<?=$d->fatherName?>">
                    <div id="nome" class="form-text"></div>
                </div>
 ...
 <div class="row">
                <div class="form-group col-md-4">
                    ...
                    <select style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao name="document_type" id="document_type" class="form-select">
                        <option value="">:: Selecione ::</option>
                ...
                <div class="form-group col-md-8">
                    ...
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao type="text" name="document_number" id="document_number" class="form-control" placeholder="Número do Documento" value="<?=$d->document_number?>">
                    <div id="nome" class="form-text"></div>
                </div>
...
<div class="row">
                <div class="form-group col-md-4">
                    ...
                    <select style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao name="document_issuingState" id="document_issuingState" class="form-select">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao type="text" name="document_issuingAuthority" id="document_issuingAuthority" class="form-control" placeholder="Orgão Emissor" value="<?=$d->document_issuingAuthority?>">
                    <div id="nome" class="form-text"></div>
                </div>

                <div class="form-group col-md-4">
                    <label class="form-label" for="document_issueDate">Data da Emissão*</label>
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao type="text" tipo="data" name="document_issueDate" id="document_issueDate" class="form-control" placeholder="Data da Emissão" value="<?=dataBr(trim($d->document_issueDate))?>">
                    <div id="nome" class="form-text"></div>
                </div>
...
<div class="row">
                <div class="form-group col-md-4">
                    ...
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao type="text" name="address_zipCode" id="address_zipCode" class="form-control" placeholder="CEP" value="<?=$d->address_zipCode?>">
                    <div id="nome" class="form-text"></div>
                </div>
                ...
                <div class="form-group col-md-8">
                    ...
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao type="text" name="address_street" id="address_street" class="form-control" placeholder="Avenida, rua ou Beco" value="<?=$d->address_street?>">
                    <div id="nome" class="form-text"></div>
                </div>
...
<div class="row">
                <div class="form-group col-md-3">
                    ...
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao type="text" name="address_number" id="address_number" class="form-control" placeholder="Número da Moradia" value="<?=$d->address_number?>">
                    <div id="nome" class="form-text"></div>
                </div>

                <div class="form-group col-md-9">
                    <label class="form-label" for="address_complement">Complemento</label>
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao type="text" name="address_complement" id="address_complement" class="form-control" placeholder="Conjunto, Edifício, Condomínio, Bloco" value="<?=$d->address_complement?>">
                    <div id="nome" class="form-text"></div>
                </div>
...
<div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao type="text" name="address_neighborhood" id="address_neighborhood" class="form-control" placeholder="Bairro" value="<?=$d->address_neighborhood?>">
                    <div id="nome" class="form-text"></div>
                </div>
                ...
                <div class="form-group col-md-5">
                    ...
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao type="text" name="address_city" id="address_city" class="form-control" placeholder="Cidade" value="<?=$d->address_city?>">
                    <div id="nome" class="form-text"></div>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <select style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao name="address_state" id="address_state" class="form-select">
                        <option value="">:: Selecione o Estado ::</option>
                        <?php
                        foreach($siglas as $i => $sigla){
                        ?>
...
<div class="row">               
                <div class="form-group col-md-8">
                    ...
                    <select style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao name="bankCode" id="bankCode" class="form-select">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao name="accountType" id="accountType" class="form-select">
                        <option value="">:: Selecione ::</option>
...
<div class="row">  
                <div class="form-group col-md-6">
                    ...
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao type="text" name="accountNumber" id="accountNumber" class="form-control" placeholder="Número da Conta" value="<?=$d->accountNumber?>">
                    <div id="nome" class="form-text"></div>
                </div>
                ...
                <div class="form-group col-md-2">
                    ...
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao type="text" name="accountDigit" id="accountDigit" class="form-control" placeholder="Dígito da Conta" value="<?=$d->accountDigit?>">
                    <div id="nome" class="form-text"></div>
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input style="border-radius:20px;box-shadow: 0px 0px 5px 1px #1c4a9b;" acao type="text" name="branchNumber" id="branchNumber" class="form-control" placeholder="Agência" value="<?=$d->branchNumber?>">
                    <div id="nome" class="form-text"></div>
                </div>
        ...
        <div class="mt-2" style="text-align:center">
            <a class="btn btn-primary btn-lg botao-capital"  href="#" local="fgts/home.php"><i class="fa-solid fa-angles-right"></i> Contratar FGTS</a>
        </div>
